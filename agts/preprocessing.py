...
class Impute:
    def Imputation_single(self, data: pd.DataFrame, input=None, missing_values=np.nan, strategy='mean', copy=True,
    ...
    def Imputation_multi(self, data: pd.DataFrame, estimator=None, missing_values=np.nan, sample_posterior=False,
    ...
    def Imputation_fill(self, data: pd.DataFrame, value=None, method=None, axis=None, inplace=False, limit=None,
    ...
    def Imputation_knn(self, data: pd.DataFrame, input=None, missing_values=np.NaN, n_neighbors=5, weights='uniform',
    ...
    def test(self):
        ...
        print()
        print("single")
        print(self.Imputation_single(data=df))
        print()
        print("multi")
        print(self.Imputation_multi(df, sample_posterior=True))
        print()
        print("fill")
        print(self.Imputation_fill(df, method='pad'))
        print()
        print("knn")
        print(self.Imputation_knn(df))
